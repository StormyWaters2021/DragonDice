...
MELEE = {
"count": ["Counter", "Sneak Attack", "Sortie", ], 
...
MANEUVER = {
"count": ["Elevate", "Firewalking", "Hoof", "Rend", "Teleport", ], 
"extra": ["Wave", "Wayfare", ], 
"reroll": [],
"nosave": [],
"normal": ["Maneuver"],
...
SAVE = {
"count": ["Cloak", "Counter", "Fabricate", "Hoof", "Kick", "Rise from the Ashes", "Sortie", ], 
...
"extra": ["Belly", "Dispel Magic", "Fly", "Trample", ], 
"reroll": [],
"nosave": [],
"normal": [],
}
...
NON_MANEUVER = {
"count": [], 
"extra": ["Belly", "Element Fire", "Element Water", "Element Earth", "Element Death", "Element Air", "Ferry", "Firewalking", "Gate", "Regenerate", "Teleport", "Wild Growth", ], 
"reroll": [],
"nosave": [],
"normal": [],
}
...
SPELL_SPECIES = {
    ...
    "Dracolem": ["aa13d920-5e64-425f-979a-957f38b4fa0b", "aa85ad40-40c2-40a5-89fd-512837528e8e", "aaaf3e5c-93aa-4ce4-bf8b-45e8d21d595f",
